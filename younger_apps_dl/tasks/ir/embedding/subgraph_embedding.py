...
from younger_apps_dl.models import GCN_NP, GAT_NP, SAGE_NP, Encoder_NP, LinearCls
from younger_apps_dl.utils.neural_network import load_checkpoint
from younger_apps_dl.datasets.node_dataset import NodeDataset
...
class SubgraphEmbedding(BaseTask[SubgraphEmbeddingOptions]):
